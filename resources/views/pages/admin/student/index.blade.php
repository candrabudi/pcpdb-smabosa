    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-pills flex-column flex-sm-row mb-4">
                ...
                <a class="btn btn-primary btn-sm" style="margin-right: 10px;" href="{{ $student_document && $student_document->rapor_smp ? asset('storage/' . $student_document->smp_certificate) : '' }}" download><i class="ti-xs ti ti-file me-1"></i> Ijazah SMP</a>
                ...
                <a class="btn btn-primary btn-sm" style="margin-right: 10px;" href="{{ $student_document && $student_document->rapor_smp ? asset('storage/' . $student_document->rapor_smp) : '' }}" download><i class="ti-xs ti ti-file me-1"></i> Rapor SMP</a>
