        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('setting_student_mother') }}" id="formValidationExamples" method="post">
                    @csrf
                    @include('components.partials.parent_form', [
                        'parent' => $student_father,
                        'parentType' => 'father',
                        'route' => 'setting_student_father',
                        'title' => 'Data Ayah Peserta Didik',
                    ])
                    @include('components.partials.parent_form', [
                        'parent' => $student_mother,
                        'parentType' => 'mother',
                        'route' => 'setting_student_mother',
                        'title' => 'Data Ibu Peserta Didik',
                    ])
                </form>
                <div class="card mb-4">
                    <div class="card-body">
...
@section('scripts')
    <script>
        $(document).ready(function() {
            document.getElementById("father_income").addEventListener("keydown", function(event) {
